...
UPDATE employees SET first_name = :first_name_input, last_name = :last_name_input, birth_date = :birth_date_input WHERE employee_id = :employee_id_input;
...
UPDATE positions SET position_name = :position_name_input, position_rank = :position_rank_input WHERE position_id = :position_id_input;
...
UPDATE tasks SET assigned_task = :assigned_task_input, assigned_to = :assigned_to_input WHERE task_id = :task_id_input;
